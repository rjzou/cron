...
import com.eeepay.boss.utils.dbutils.HumpBeanProcessor;
import com.eeepay.boss.utils.dbutils.HumpMatcher;
...
public class HistoryDao {
	...
	public int update(String sql, Object[] params) throws SQLException {
		queryRunner = new QueryRunner(historyDataSource);
		int affectedRows = 0;
		try {
			if (params == null) {
	 ...
	 * @throws SQLException 
	 */
	public int updateByTranscation(String sql, Object[] params,Connection conn) throws SQLException {
	...
	public long updateGetID(String sql, List<Object> paramList) throws SQLException {
		Connection conn=historyDataSource.getConnection();
	...
	public  Connection getConnection(){
	     try {
	           return historyDataSource.getConnection();
	     } catch (Exception e) {
